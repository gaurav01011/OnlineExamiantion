...
public class TestExaminationFrame extends javax.swing.JInternalFrame implements Runnable {

    private Thread examThread;
    private int questionIndex = 0;
    private ArrayList<String> questionArrayList;

    public TestExaminationFrame() {
        try {
            initComponents();
    ...
    private void initComponents() {
        ...
        examReportButton.setText("EXAM REPORT");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(examReportButton, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(examReportButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
...
try
{
        ...
        int questionsize = Config.testQuestionobjectiveMap.values().size();
...
//  new Thread(this);
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        if (option1RadioButton.isSelected() || option2RadioButton.isSelected() || option3RadioButton.isSelected() || option4RadioButton.isSelected()) {
            ...
            Objectives objective=Config.testQuestionobjectiveMap.get(questionTextArea.getText());
            int marks=0;
            ...
            if(questionArrayList.size()==Config.testQuestionobjectiveMap.values().size())
            {
            ...
            remainingQuestionLabel.setText("Remaining Que:"+(Config.testQuestionobjectiveMap.values().size()-questionArrayList.size()));
            getQuestion();//this same method we are calling  from next button
    ...
    private void resultButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resultButtonActionPerformed
        ...
        try {
            ...
            examResult.setCreated(new Date());
            examResult.setExamDate(new Date());
            examResult.setMarks(totalMarks);
            examResult.setModified(new Date());
             if (totalMarks >= marks / 2) {
                 examResult.setResult("Passed");
            } else {
                 examResult.setResult("Failed");
            }
             examResult.setStatus(1);
             examResult.setUser(Config.user);
             ExaminationServices.addExamResult(examResult);
             
             
             java.sql.Connection con = DatabaseConnection.getDatabaseSession().connection();
                File f = new File(".");
...
"     INNER JOIN `objectives` objectives ON examinations.`objective_id` = objectives.`id` where users.`id`="+Config.user.getId();
               ...
               String pdfFileName=f.getCanonicalPath() +"/" + Config.user.getName() +".pdf";
    ...
    private void examReportButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_examReportButtonActionPerformed
        ...
        try
        {
             ...
             java.sql.Connection con = DatabaseConnection.getDatabaseSession().connection();
                ...
                JasperDesign jd = JRXmlLoader.load(f.getCanonicalPath() + "/build/classes/org/nlt/report/ExaminationDetails.jrxml");
...
"     INNER JOIN `users` users ON examinations.`user_id` = users.`id`";
    ...
    private void getQuestion() {
        Collection<Objectives> objectieValues = Config.testQuestionobjectiveMap.values();
